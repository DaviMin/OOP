# ted je tady pozadavek na dekorator, je to jeden z paternu
# bude tam i co je LAMBDA (vylozene pro funkci, ktera bude na jednom miste jenom jedinkrat pouzita)
# a pak jeste MAP
